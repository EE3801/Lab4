...
Since we will now be processing 32 channels instead of the 8 channels we were processing previously, check that the run time for the job is set to 24 hours:
